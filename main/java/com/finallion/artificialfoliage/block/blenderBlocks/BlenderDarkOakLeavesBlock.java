...
public class BlenderDarkOakLeavesBlock extends Block implements BlockEntityProvider, IBlenderBlock, IBlenderLeavesBlock, IARFOLeaves {

    public BlenderDarkOakLeavesBlock() {
        super(FabricBlockSettings.copyOf(Blocks.DARK_OAK_LEAVES));
    }
