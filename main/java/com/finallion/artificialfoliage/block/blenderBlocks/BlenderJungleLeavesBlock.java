...
public class BlenderJungleLeavesBlock extends Block implements BlockEntityProvider, IBlenderBlock, IBlenderLeavesBlock, IARFOLeaves {

    public BlenderJungleLeavesBlock() {
        super(FabricBlockSettings.copyOf(Blocks.JUNGLE_LEAVES));
    }
