...
public abstract class BaseBakedModel implements BakedModel, UnbakedModel, FabricBakedModel {
    ...
    public void emitBlockQuads(BlockRenderView blockRenderView, BlockState blockState, BlockPos blockPos, Supplier<Random> supplier, RenderContext renderContext) {
        BlenderBlockEntity blockEntity = (BlenderBlockEntity) blockRenderView.getBlockEntity(blockPos);
