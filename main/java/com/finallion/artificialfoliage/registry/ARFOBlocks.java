...
public class ARFOBlocks {
    ...
    public static final Block GRASS_SLAB = createBlock(new ARFOSlabBlock(FabricBlockSettings.copyOf(Blocks.GRASS_BLOCK).breakByTool(FabricToolTags.SHOVELS)), "grass_slab");
    public static final Block DIRT_SLAB = createBlock(new ARFOSlabBlock(FabricBlockSettings.copyOf(Blocks.DIRT).breakByTool(FabricToolTags.SHOVELS)), "dirt_slab");
    public static final Block COARSE_DIRT_SLAB = createBlock(new ARFOSlabBlock(FabricBlockSettings.copyOf(Blocks.COARSE_DIRT).breakByTool(FabricToolTags.SHOVELS)), "coarse_dirt_slab");
    public static final Block PODZOL_SLAB = createBlock(new ARFOSlabBlock(FabricBlockSettings.copyOf(Blocks.PODZOL).breakByTool(FabricToolTags.SHOVELS)), "podzol_slab");
    public static final Block MYCELIUM_SLAB = createBlock(new ARFOSlabBlock(FabricBlockSettings.copyOf(Blocks.MYCELIUM).breakByTool(FabricToolTags.SHOVELS)), "mycelium_slab");
    public static final Block ARTIFICIAL_SOIL_SLAB = createBlock(new ARFOSlabBlock(FabricBlockSettings.copyOf(Blocks.DIRT).breakByTool(FabricToolTags.SHOVELS)), "artificial_soil_slab");
    public static final Block GRASS_PATH_SLAB = createBlock(new ARFOSmallerSlabBlock(FabricBlockSettings.copyOf(Blocks.GRASS_PATH).breakByTool(FabricToolTags.SHOVELS)), "grass_path_slab");
    public static final Block NETHERRACK_SLAB = createBlock(new ARFONetherSlabBlock(FabricBlockSettings.copyOf(Blocks.NETHERRACK).breakByTool(FabricToolTags.PICKAXES)), "netherrack_slab");
    public static final Block CRIMSON_NYLIUM_SLAB = createBlock(new ARFONetherSlabBlock(FabricBlockSettings.copyOf(Blocks.CRIMSON_NYLIUM).breakByTool(FabricToolTags.PICKAXES)), "crimson_nylium_slab");
    public static final Block WARPED_NYLIUM_SLAB = createBlock(new ARFONetherSlabBlock(FabricBlockSettings.copyOf(Blocks.WARPED_NYLIUM).breakByTool(FabricToolTags.PICKAXES)), "warped_nylium_slab");
