...
public class ARFOItems {
    ...
    public static final Item GRASS_SEED = createItem(new ARFOGrassSeedItem(new Item.Settings().group(ArtificialFoliage.ADVANCED)), "grass_seed");
    ...
    public static final Item BLENDER_GRASS_BLOCK = createItem(new BlockItem(ARFOBlocks.BLENDER_GRASS_BLOCK, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.BLENDER_GRASS_BLOCK));
    public static final Item BLENDER_OAK_LEAVES_BLOCK = createItem(new BlockItem(ARFOBlocks.BLENDER_OAK_LEAVES_BLOCK, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.BLENDER_OAK_LEAVES_BLOCK));
    public static final Item BLENDER_DARK_OAK_LEAVES_BLOCK = createItem(new BlockItem(ARFOBlocks.BLENDER_DARK_OAK_LEAVES_BLOCK, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.BLENDER_DARK_OAK_LEAVES_BLOCK));
    public static final Item BLENDER_JUNGLE_LEAVES_BLOCK = createItem(new BlockItem(ARFOBlocks.BLENDER_JUNGLE_LEAVES_BLOCK, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.BLENDER_JUNGLE_LEAVES_BLOCK));
    public static final Item BLENDER_ACACIA_LEAVES_BLOCK = createItem(new BlockItem(ARFOBlocks.BLENDER_ACACIA_LEAVES_BLOCK, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.BLENDER_ACACIA_LEAVES_BLOCK));

    public static final Item WAND_OF_NATURE_COLORS = createItem(new WandOfNatureColors(new Item.Settings().group(ArtificialFoliage.ADVANCED)), "wand_of_nature_colors");
    public static final Item WAND_OF_WATER_COLORS = createItem(new WandOfWaterColors(new Item.Settings().group(ArtificialFoliage.ADVANCED)), "wand_of_water_colors");
    public static final Item WAND_OF_NETHER_COLORS = createItem(new WandOfNetherColors(new Item.Settings().group(ArtificialFoliage.ADVANCED)), "wand_of_nether_colors");
    public static final Item WAND_OF_SNOW = createItem(new WandOfSnow(new Item.Settings().group(ArtificialFoliage.ADVANCED)), "wand_of_snow");
    public static final Item WAND_OF_CHAOS_COLORS = createItem(new WandOfChaosColors(new Item.Settings().group(ArtificialFoliage.ADVANCED)), "wand_of_chaos_colors");
    public static final Item WAND_OF_IMITATION = createItem(new WandOfImitation(new Item.Settings().group(ArtificialFoliage.ADVANCED)), "wand_of_imitation");
