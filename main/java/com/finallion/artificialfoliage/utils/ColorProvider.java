...
public class ColorProvider {
    ...
    // dynamic foliage item color
    public static final ItemColorProvider JUNGLE_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.95, 0.9);
    public static final ItemColorProvider SAVANNA_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(1.0, 0.0);
    public static final ItemColorProvider JUNGLE_EDGE_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.95, 0.8);
    public static final ItemColorProvider FOREST_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.7, 0.8);
    public static final ItemColorProvider BIRCH_FOREST_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.6, 0.6);
    public static final ItemColorProvider PLAINS_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.8, 0.4);
    public static final ItemColorProvider WATERS_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.5, 0.5);
    public static final ItemColorProvider MOUNTAINS_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.2, 0.3);
    public static final ItemColorProvider MUSHROOM_FIELDS_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.9, 1.0);
    public static final ItemColorProvider SNOWY_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.0, 0.5);
    public static final ItemColorProvider MEGA_TAIGA_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.3, 0.8);
    public static final ItemColorProvider TAIGA_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.25, 0.8);
    public static final ItemColorProvider SNOWY_BEACH_LEAVES_ITEM_COLOR = (item, layer) -> GrassColors.getColor(0.05, 0.3);

    // hardcoded foliage item color
    public static final ItemColorProvider SWAMP_LEAVES_ITEM_COLOR = (item, layer) -> BiomeEffects.GrassColorModifier.SWAMP.getModifiedGrassColor(0.8, 0.9, 6975545);
    public static final ItemColorProvider BADLANDS_LEAVES_ITEM_COLOR = (item, layer) -> BiomeEffects.GrassColorModifier.NONE.getModifiedGrassColor(0.5, 0.5, 10387789);
    public static final ItemColorProvider LUSH_SWAMP_LEAVES_ITEM_COLOR = (item, layer) -> BiomeEffects.GrassColorModifier.NONE.getModifiedGrassColor(0.8, 0.9, 5011004);
    public static final ItemColorProvider DARK_FOREST_LEAVES_ITEM_COLOR = (item, layer) -> BiomeEffects.GrassColorModifier.DARK_FOREST.getModifiedGrassColor(0.5, 0.5, FoliageColors.getColor(0.7, 0.8));
