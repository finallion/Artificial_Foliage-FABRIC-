...
public class ColorableGrassBlockModel extends ColorableBakedModel {
    ...
    public @Nullable BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        grassBakedModel = loader.getOrLoadModel(new Identifier(ArtificialFoliage.MOD_ID, "block/colorable_grass_block")).bake(loader, textureGetter, rotationContainer, modelId);
