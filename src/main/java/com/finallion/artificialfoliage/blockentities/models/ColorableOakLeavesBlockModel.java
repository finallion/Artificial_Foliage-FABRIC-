...
public class ColorableOakLeavesBlockModel extends ColorableBakedModel {
    ...
    public @Nullable BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        grassBakedModel = loader.getOrLoadModel(new Identifier(ArtificialFoliage.MOD_ID, "block/colorable_oak_leaves")).bake(loader, textureGetter, rotationContainer, modelId);
