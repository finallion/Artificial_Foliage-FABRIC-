...
public abstract class BopBayouWater extends ARFOWater {
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) BOPBlocks.BOP_BAYOU_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Still extends BopBayouWater {
        public int getLevel(FluidState state) {
            return 8;
        }
