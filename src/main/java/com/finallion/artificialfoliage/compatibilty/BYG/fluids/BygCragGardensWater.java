...
public abstract class BygCragGardensWater extends ARFOWater {
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) BYGBlocks.BYG_CRAG_GARDENS_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Still extends BygCragGardensWater {
        public int getLevel(FluidState state) {
            return 8;
        }
