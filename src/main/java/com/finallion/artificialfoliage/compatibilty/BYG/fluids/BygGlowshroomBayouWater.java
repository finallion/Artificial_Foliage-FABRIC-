...
public abstract class BygGlowshroomBayouWater extends ARFOWater {
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) BYGBlocks.BYG_GLOWSHROOM_BAYOU_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Still extends BygGlowshroomBayouWater {
        public int getLevel(FluidState state) {
            return 8;
        }
