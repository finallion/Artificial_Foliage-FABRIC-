...
public abstract class BygPollutedLakeWater extends ARFOWater {
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) BYGBlocks.BYG_POLLUTED_LAKE_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Still extends BygPollutedLakeWater {
        public int getLevel(FluidState state) {
            return 8;
        }
