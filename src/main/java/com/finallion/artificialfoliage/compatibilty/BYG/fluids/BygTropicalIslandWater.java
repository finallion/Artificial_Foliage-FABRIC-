...
public abstract class BygTropicalIslandWater extends ARFOWater {
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) BYGBlocks.BYG_TROPICAL_ISLAND_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Still extends BygTropicalIslandWater {
        public int getLevel(FluidState state) {
            return 8;
        }
