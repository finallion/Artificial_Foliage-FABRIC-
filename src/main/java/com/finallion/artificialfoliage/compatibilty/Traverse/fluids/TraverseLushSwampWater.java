...
public abstract class TraverseLushSwampWater extends ARFOWater {
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) TraverseBlocks.TRAVERSE_LUSH_SWAMP_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Still extends TraverseLushSwampWater {
        public int getLevel(FluidState state) {
            return 8;
        }
