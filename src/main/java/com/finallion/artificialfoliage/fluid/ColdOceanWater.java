...
public abstract class ColdOceanWater extends ARFOWater {
    ...
    protected BlockState toBlockState(FluidState state) {
        return (BlockState) ARFOBlocks.COLD_OCEAN_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Still extends ColdOceanWater {
        public int getLevel(FluidState state) {
            return 8;
        }
