...
public class WandOfNetherColors extends WandItem {

    public WandOfNetherColors(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (block instanceof IGiveColor && playerEntity != null) {
            if (((IGiveColor) block).setColor(context, world, blockPos, getColor())) {
                playerEntity.playSound(SoundEvents.ITEM_NETHER_WART_PLANT, 0.5F, 1);
