...
import com.finallion.artificialfoliage.blockentities.*;
...
public class ARFOBlocks {
    ...
    public static final Block COLORABLE_GRASS_BLOCK = createBlock(new ColorableGrassBlock(), "colorable_grass_block");
    public static final Block COLORABLE_OAK_LEAVES = createBlock(new ColorableOakLeavesBlock(), "colorable_oak_leaves");
    public static final Block COLORABLE_DARK_OAK_LEAVES = createBlock(new ColorableDarkOakLeavesBlock(), "colorable_dark_oak_leaves");
    public static final Block COLORABLE_JUNGLE_LEAVES = createBlock(new ColorableJungleLeavesBlock(), "colorable_jungle_leaves");
    public static final Block COLORABLE_ACACIA_LEAVES = createBlock(new ColorableAcaciaLeavesBlock(), "colorable_acacia_leaves");

    public static final BlockEntityType<ColorableBlockEntity> COLORABLE_BLOCK_ENTITY_TYPE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(ArtificialFoliage.MOD_ID, "color"),
            FabricBlockEntityTypeBuilder.create(ColorableBlockEntity::new,
                    COLORABLE_GRASS_BLOCK,
                    COLORABLE_OAK_LEAVES,
                    COLORABLE_DARK_OAK_LEAVES,
                    COLORABLE_JUNGLE_LEAVES,
                    COLORABLE_ACACIA_LEAVES
            ).build(null));
