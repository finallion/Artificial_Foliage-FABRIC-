...
public class ARFOItems {
    ...
    public static final Item COLORABLE_GRASS_BLOCK_ITEM = createItem(new BlockItem(ARFOBlocks.COLORABLE_GRASS_BLOCK, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.COLORABLE_GRASS_BLOCK));
    public static final Item COLORABLE_OAK_LEAVES_ITEM = createItem(new BlockItem(ARFOBlocks.COLORABLE_OAK_LEAVES, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.COLORABLE_OAK_LEAVES));
    public static final Item COLORABLE_DARK_OAK_LEAVES_ITEM = createItem(new BlockItem(ARFOBlocks.COLORABLE_DARK_OAK_LEAVES, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.COLORABLE_DARK_OAK_LEAVES));
    public static final Item COLORABLE_JUNGLE_LEAVES_ITEM = createItem(new BlockItem(ARFOBlocks.COLORABLE_JUNGLE_LEAVES, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.COLORABLE_JUNGLE_LEAVES));
    public static final Item COLORABLE_ACACIA_LEAVES_ITEM = createItem(new BlockItem(ARFOBlocks.COLORABLE_ACACIA_LEAVES, new Item.Settings().group(ArtificialFoliage.ADVANCED)), Registry.BLOCK.getId(ARFOBlocks.COLORABLE_ACACIA_LEAVES));


    public static final Item WAND_OF_NATURE_COLORS = createItem(new WandOfNatureColors(new Item.Settings().group(ArtificialFoliage.ADVANCED).maxCount(1)), "wand_of_nature_colors");
    public static final Item WAND_OF_WATER_COLORS = createItem(new WandOfWaterColors(new Item.Settings().group(ArtificialFoliage.ADVANCED).maxCount(1)), "wand_of_water_colors");
    public static final Item WAND_OF_NETHER_COLORS = createItem(new WandOfNetherColors(new Item.Settings().group(ArtificialFoliage.ADVANCED).maxCount(1)), "wand_of_nether_colors");
    public static final Item WAND_OF_CHAOS_COLORS = createItem(new WandOfChaosColors(new Item.Settings().group(ArtificialFoliage.ADVANCED).maxCount(1)), "wand_of_chaos_colors");
    public static final Item WAND_OF_IMITATION = createItem(new WandOfImitation(new Item.Settings().group(ArtificialFoliage.ADVANCED).maxCount(1)), "wand_of_imitation");
